    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">Canteen</span> <span class="clr-green">Reservation</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">Canteen</span> <span class="clr-green md">Reservation</span></div>
                ...
                if (data[key].Order_Status === true){
                    ...
                    UserCart.forEach(itemID => {
                        ...
                        tr.innerHTML = `
                            ...
                            <td data-label= "Price">$ ${newMenu[foodID-1].fields.price}</td>
                            <td data-label= "Quantity">${itemID.Quantity}</td>
                            <td data-label= "Sub Total">$ ${subTotal}</td>
                        `                        
